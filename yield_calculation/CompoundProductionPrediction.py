...
def yield_prediction(target,g,C_source,turned_on_underground_reactions):
    ...
    model.reactions.get_by_id(BIOMASS.id).lower_bound= reference*g #set the biomass production contstraint
...
for target in targets:
    ...
    for carbon_source in carbon_sources:
        ...
        underground=yield_prediction(target,biomass_constraint,carbon_source,[ 'u0134', 'u0214','u0065','u0300'])#underground_reactions.keys())
